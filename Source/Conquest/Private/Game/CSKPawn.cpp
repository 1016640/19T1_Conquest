...
void ACSKPawn::TravelToLocation(const FVector& Location, float TravelTime, bool bCancellable)
{
	PawnMovement->TravelToLocation(Location, TravelTime, bCancellable);
}
